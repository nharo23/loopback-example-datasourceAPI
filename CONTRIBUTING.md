...
Thank you for your interest in `loopback2.0_datasourceAPI`, an open source project
administered by StrongLoop.

Contributing to `loopback2.0_datasourceAPI` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/strongloop/loopback-example-datasourceAPI)
